 ...
 *
 * The order of document IDs in {@link #docIds} does not need to be sorted.
...
public class GroupedNestedDocIdSetIterator extends DocIdSetIterator {
    ...
    public GroupedNestedDocIdSetIterator(final BitSet parentBitSet, final ArrayList<Integer> docIds) {
