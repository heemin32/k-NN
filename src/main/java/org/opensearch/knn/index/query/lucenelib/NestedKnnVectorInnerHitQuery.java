...
/**
 * This query manages the inner hit query for a nested k-NN field to return multiple nested field documents
 * rather than only the highest-scoring nested field document in inner_hit block.
 *
 ...
 */
@Builder
public class NestedKnnVectorInnerHitQuery extends Query {
    ...
    public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
        ...
        ResultUtil.reduceToTopK(perLeafResults, internalNestedKnnVectorQuery.getK());
    ...
    private TopDocs[] retrieveAll(
        ...
        for (int i = 0; i < perLeafResults.size(); i++) {
            ...
            nestedQueryTasks.add(() -> {
                ...
                DocIdSetIterator acceptedDocIds = new FilteredDocIdSetIterator(allSiblings) {
                    @Override
                    protected boolean match(final int i) throws IOException {
                        return queryFilter.get(i);
                    }
                };
                TopDocs topDocs = internalNestedKnnVectorQuery.knnExactSearch(leafReaderContext, acceptedDocIds);
    ...
    public boolean equals(final Object o) {
        ...
        NestedKnnVectorInnerHitQuery other = (NestedKnnVectorInnerHitQuery) o;
