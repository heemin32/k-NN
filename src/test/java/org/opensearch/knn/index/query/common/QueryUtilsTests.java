...
public class QueryUtilsTests extends TestCase {
    ...
    public void testGetAllSiblings_whenEmptyDocIds_thenEmptyIterator() {
        ...
        // Run
        DocIdSetIterator docIdSetIterator = queryUtils.getAllSiblings(leafReaderContext, Collections.emptySet(), bitSetProducer);
    ...
    public void testGetAllSiblings_whenNonEmptyDocIds_thenReturnAllSiblings() {
        ...
        DocIdSetIterator docIdSetIterator = queryUtils.getAllSiblings(leafReaderContext, docIds, bitSetProducer);

        // Verify
        Set<Integer> expectedDocIds = Set.of(0, 1, 8, 9);
