...
@Log4j2
@AllArgsConstructor
public class InnerHitsIT extends KNNRestTestCase {
    private static final String INDEX_NAME = "test-index-innerhits-search";
    ...
    @SneakyThrows
    public void testInnerHits_whenFilteredOnParentDoc_thenReturnAllNestedDoc() {
        ...
        Response response = queryNestedFieldWithInnerHits(INDEX_NAME, 10, queryVector, FIELD_NAME_PARKING, FIELD_VALUE_TRUE);
    ...
    @SneakyThrows
    public void testInnerHits_whenFilteredOnNestedFieldDoc_thenReturnFilteredNestedDoc() {
        int numberOfNestedFields = 2;
        createKnnIndex(engine, mode, dimension, dataType);
        ...
        // Run
        Float[] queryVector = createVector();
        Response response = queryNestedFieldWithInnerHits(
            INDEX_NAME,
            10,
            queryVector,
    ...
    *                      }
     ...
     *  }
     */
    private Response queryNestedFieldWithInnerHits(
        final String index,
        final Integer k,
        final Object[] vector,
